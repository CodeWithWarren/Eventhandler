...
var _hsq = _hsq || [];
var _paq = _paq || [];
_hsq.push(['setTrackingGate', 'AnalyticsTracking:CleanCookies']);
_hsq.push(['setPortalId', 20944943]);
_hsq.push(['trackPageView']);
_hsq.push(['setLegacy', false]);
_hsq.push(['addHashedCookieDomain', '224894981']);
_hsq.push(['addHashedCookieDomain', '233546881']);
_hsq.push(['addHashedCookieDomain', '248155544']);
_hsq.push(['addHashedCookieDomain', '20629287']);
_hsq.push(['addHashedCookieDomain', '251652889']);
_hsq.push(['enableAutomaticLinker', true]);
_hsq.push(['embedHubSpotScript', 'https://js-na1.hs-scripts.com/20944943.js', 'hs-script-loader']);
...
(function() {
    ...
    hstc.tracking.Tracker.prototype.removeCookies = function() {
        if (this.hasTrackingGate("AnalyticsTracking:CleanCookies")) {
    ...
    ;
    !function(t) {
        var e, i, n, r, s, o, c, a, h, u, l, g, p, f, d, k, m, y = "sizzle" + -new Date, v = t.document, C = 0, T = 0, _ = rt(), w = rt(), x = rt(), S = !1, b = function(t, e) {
            if (t === e) {
                S = !0;
                return 0
            }
            return 0
        }, E = "undefined", I = 1 << 31, D = {}.hasOwnProperty, A = [], L = A.pop, O = A.push, N = A.push, P = A.slice, R = A.indexOf || function(t) {
            for (var e = 0, i = this.length; e < i; e++)
                if (this[e] === t)
                    return e;
            return -1
        }
        , U = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", H = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", q = H.replace("w", "w#"), F = "\\[" + M + "*(" + H + ")" + M + "*(?:([*^$|!~]?=)" + M + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + q + ")|)|)" + M + "*\\]", j = ":(" + H + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + F.replace(3, 8) + ")*)|.*)\\)|)", B = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$","g"), V = new RegExp("^" + M + "*," + M + "*"), K = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), $ = new RegExp(M + "*[+~]"), W = new RegExp("=" + M + "*([^\\]'\"]*)" + M + "*\\]","g"), G = new RegExp(j), z = new RegExp("^" + q + "$"), Y = {
            ID: new RegExp("^#(" + H + ")"),
            CLASS: new RegExp("^\\.(" + H + ")"),
        ...
        function yt(t, e, i, n, r, s) {
            ...
            return st((function(s, o, c, a) {
                var h, u, l, g = [], p = [], f = o.length, d = s || Tt(e || "*", c.nodeType ? [c] : c, []), k = !t || !s && e ? d : mt(d, g, t, c, a), m = i ? r || (s ? t : f || n) ? [] : o : k;
                i && i(k, m, c, a);
                if (n) {
                    h = mt(m, p);
                    n(h, [], c, a);
        ...
        function Ct(t, e) {
            var i = 0
              ...
              , c = function(c, h, u, g, p) {
                var f, d, k, m = [], y = 0, v = "0", T = c && [], _ = null != p, w = a, x = c || o && r.find.TAG("*", p && h.parentNode || h), S = C += null == w ? 1 : Math.random() || .1, b = x.length;
                if (_) {
                    a = h !== l && h;
                    n = i
                }
                ...
                if (s && v !== y) {
                    ...
                    if (c) {
                        if (y > 0)
                            for (; v--; )
                                T[v] || m[v] || (m[v] = L.call(g));
                        m = mt(m)
                    }
                    N.apply(g, m);
                    _ && !c && m.length > 0 && y + e.length > 1 && nt.uniqueSort(g)
                }
                if (_) {
                    C = S;
                    a = w
                ...
                if (t !== null) {
                    if (e && t.forEach === e) {
                        ...
                        for (var r = 0, s = t.length; r < s; r++) {
                            if (i.call(n, t[r], r, t) === false) {
                                return;
                            }
                        }
                    } else {
                        for (var o in t) {
                            if (t.hasOwnProperty(o) && i.call(n, t[o], o, t) === false) {
                                return;
                            }
                        }
                    }
